...
public class PharmacistWindow extends JFrame implements ActionListener{
    ...
    public PharmacistWindow(){
        ...
        imageIcon1 = new ImageIcon("PharmacistWindow.jpg");
        label1 = new JLabel(imageIcon1);
        label1.setBounds(0, 0, 600, 400);

        label2.setText("PHARMACIST DASHBOARD");
