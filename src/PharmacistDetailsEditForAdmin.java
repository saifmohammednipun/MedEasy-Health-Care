...
public class PharmacistDetailsEditForAdmin extends JFrame implements ActionListener {
    ...
    private String[] columns = {"Pharmacist ID", "Designation", "Pharmacist Name", "Salary", "Password"};

    private String[] rows = new String[5];

    public PharmacistDetailsEditForAdmin() {
        setVisible(true);
        ...
        label1 = new JLabel("Edit Pharmacist Details");
        ...
        button1 = new JButton("Add Pharmacist");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == button3) {
            ...
            try {
                File inputFile = new File("PharmacistDetails.txt");
        ...
        if(e.getSource() == button6){
            try{
                File f1 = new File("PharmacistDetails.txt");
                if(!f1.exists()){
                    f1.createNewFile();
                }
