...
public class ReceptionistSetPassword extends JFrame implements ActionListener {
    private JLabel label1, label2, label3, label4;
    private JTextField textField1, textField2, textField3, textField4, textField5;
    private JPasswordField passwordField1;
    private JButton button1, button2;

    public ReceptionistSetPassword() {
        super("Set Password");
        setVisible(true);
        ...
        label1 = new JLabel("Receptionist ID: ");
            ...
            try{
                ...
                for(int i=0; i<number_of_line; i++) {
                    ...
                    if (arr1[i].getId().equals(ID)) {
                        File f = new File("ReceptionistPassword.txt");
                        if (!f.exists()) {
                            f.createNewFile();
                        }
