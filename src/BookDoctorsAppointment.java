...
public class BookDoctorsAppointment extends JFrame implements ActionListener {
    ...
    public BookDoctorsAppointment() {
        ...
        label1 = new JLabel("Book Doctor Appointment");
        ...
        label3 = new JLabel("Patient Contact: ");
        label3.setBounds(50, 120, 100, 20);

        label4 = new JLabel("Specialist: ");
        label4.setBounds(50, 160, 100, 20);

        label5 = new JLabel("Doctor Name: ");
        label5.setBounds(50, 200, 100, 20);

        label6 = new JLabel("Slot: ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == button3) {
            ...
            try {
                File inputFile = new File("DoctorAppointmentDetails.txt");
        ...
        if(e.getSource() == button6){
            try{
                File f1 = new File("DoctorAppointmentDetails.txt");
                if(!f1.exists()){
                    f1.createNewFile();
                }
