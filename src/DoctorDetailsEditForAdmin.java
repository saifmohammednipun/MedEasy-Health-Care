...
public class DoctorDetailsEditForAdmin extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button1) {
            ...
            doctors[0] = new Doctor(textField1.getText(), textField2.getText(), textField3.getText(), textField4.getText(), textField5.getText());


        Doctor doctor = doctors[0];
        model.addRow(new Object[]{doctor.getId(), doctor.getDepartment(), doctor.getName(), doctor.getEmail(), doctor.getPassword()});
...
*/
            ...
            Object[] updatedData = {id, department, name, email, password};
            for (int i = 0; i < updatedData.length; i++) {
                model.setValueAt(updatedData[i],numberOfRow , i);
            }
